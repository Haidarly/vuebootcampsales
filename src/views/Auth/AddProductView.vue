                    ...
                    <form action="" class="bg-white rounded-[30px] p-6 md:max-w-[435px] mx-auto w-full flex flex-col shadow-sm">
                        ...
                        <div class="flex flex-col gap-[18px]">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="category" class="bg-transparent px-5 py-4 text-base border-2 rounded-full outline-none appearance-none border-borderLight focus:border-primary placeholder:text-placeholderText bg-[url('@/assets/svg/ic-chevron-down.svg')] bg-[calc(100%-20px)_center] bg-no-repeat" required>
                        ...
                        <router-link :to="{name : 'add-product-photo'}" class="btn-primary mt-[30px]">
                            Save Product
                        </router-link>
                    </form>
                </div>
